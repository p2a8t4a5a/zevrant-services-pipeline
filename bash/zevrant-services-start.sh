...
curl --insecure https://zevrant-01.zevrant-services.com:9009/zevrant-certificate-service/certs --data "$certificateRequest" -i --user "$username":"$password" -H "Content-Type: application/json" -X POST -O ~/public.crt
cat ~/public.crt
